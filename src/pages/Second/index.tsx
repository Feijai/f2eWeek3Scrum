                ...
                {page === '1' ?
                    <>
                        <MainCard width={'100%'} height={'640px'}>
                            我是TT資訊王國．敏捷騎士團的軍師小敏
                            <br /><br />
                            用你們的話來說就是<span className='highLight'>PO</span>，也就是<span className='highLight'>產品負責人 Product Owner</span>
                            <br /><br />
                            PO會負責評估產品代辦清單的價值與重要性，依序排列要執行的優先順序，對齊產品目標，最後排出<span className='highLight'>產品待辦清單 Product Backlog。</span>
                    ...
                    <>
                        <MainCard width={'100%'} height={'640px'}>
                            ...
                            <br /><br />
                            既然你都來了，來試試看<span className='highLight'>調整產品優先度，排出產品代辦清單</span>吧！
